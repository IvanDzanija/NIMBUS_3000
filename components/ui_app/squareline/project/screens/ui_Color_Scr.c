...
lv_obj_t *ui_Color_Scr = NULL;lv_obj_t *ui_Dark_Mode_Switch_Color = NULL;lv_obj_t *ui_Dark_Mode_Label_Color = NULL;lv_obj_t *ui_Home_Btn_Color = NULL;lv_obj_t *ui_Home_Img_C = NULL;lv_obj_t *ui_BL_logo_Color = NULL;lv_obj_t *ui_Colorwheel = NULL;lv_obj_t *ui_LED_color_panel = NULL;lv_obj_t *ui_LED_color_label = NULL;
// event funtions
