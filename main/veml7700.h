...
#define VEML7700_GAIN_2 UINT16_C(0x01)          /*!< ALS gain 2x */
#define VEML7700_GAIN_1 UINT16_C(0x00)          /*!< ALS gain 1x */
#define VEML7700_GAIN_1_8 UINT16_C(0x02)        /*!< ALS gain 1/8x */
#define VEML7700_GAIN_1_4 UINT16_C(0x03)        /*!< ALS gain 1/4x */

#define VEML7700_IT_800MS UINT16_C(0x03)        /*!< ALS integration time 800ms */
#define VEML7700_IT_400MS UINT16_C(0x02)        /*!< ALS integration time 400ms */
#define VEML7700_IT_200MS UINT16_C(0x01)        /*!< ALS integration time 200ms */
#define VEML7700_IT_100MS UINT16_C(0x00)        /*!< ALS integration time 100ms */
#define VEML7700_IT_50MS UINT16_C(0x08)         /*!< ALS integration time 50ms */
#define VEML7700_IT_25MS UINT16_C(0x0C)         /*!< ALS integration time 25ms */

#define VEML7700_PERS_1 UINT16_C(0x00)          /*!< ALS IRQ persistence 1 sample */
#define VEML7700_PERS_2 UINT16_C(0x01)          /*!< ALS IRQ persistence 2 samples */
#define VEML7700_PERS_4 UINT16_C(0x02)          /*!< ALS IRQ persistence 4 samples */
#define VEML7700_PERS_8 UINT16_C(0x03)          /*!< ALS IRQ persistence 8 samples */
